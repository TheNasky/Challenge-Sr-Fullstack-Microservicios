...
import { ActivateProductDto, CreateProductDto, ProductDetailsDto } from '../dto/product.dto';
...
export class ProductController {
  ...
  async activateProduct(
    @Param() product: FindOneParams,
    @Body() body: ActivateProductDto,
    @CurrentUser() user: User,
  ) {
    return this.productService.activateProduct(product.id, user.id, body.stock);
  }
